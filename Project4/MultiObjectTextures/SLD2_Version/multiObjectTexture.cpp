...
//Mac OS build: g++ -arch arm64 multiObjectTexture.cpp -x c glad/glad.c -g -F/Library/Frameworks -framework SDL2 -framework OpenGL -o MultiObjTest
...
void drawGeometry(int shaderProgram, int model1_start, int model1_numVerts, int model2_start, int model2_numVerts){
  ...
  GLint uniTexID = glGetUniformLocation(shaderProgram, "texID");
	...
	//This model is stored in the VBO starting a offset model1_start and with model1_numVerts num of vertices
	//*************
	...
	glDrawArrays(GL_TRIANGLES, model1_start, model1_numVerts); //(Primitive Type, Start Vertex, Num Vertices)
  ...
  //Draw an instance of the model (at the position & orientation specified by the model matrix above)
	...
	//************
	//Draw model #2 once
	//This model is stored in the VBO starting a offset model2_start and with model2_numVerts num of vertices
	//*************
	...
	//Draw an instance of the model (at the position & orientation specified by the model matrix above)
	glDrawArrays(GL_TRIANGLES, model2_start, model2_numVerts); //(Primitive Type, Start Vertex, Num Vertices)
}
